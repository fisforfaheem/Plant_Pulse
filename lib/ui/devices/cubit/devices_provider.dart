...
class DevicesProvider extends ChangeNotifier {
  ...
  List<Future<GetDeviceDataResponse>>? _devicesData;
  List<Future<GetDeviceDataResponse>>? get devicesData => _devicesData;
  set devicesData(List<Future<GetDeviceDataResponse>>? value) {
    _devicesData = value;
    notifyListeners();
  }
